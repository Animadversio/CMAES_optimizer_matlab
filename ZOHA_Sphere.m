classdef ZOHA_Sphere < handle
	properties
        ...
        HessD  = zeros(HB,1)  % diagonal values of the Lambda matrix
   	...
   	methods
        ...
        if self.istep == -1
            ...
            if self.rankweight == false % use the score difference as weight
                ...
                self.weights = rankweight(length(code_rank))[code_rank] % map the rank to the corresponding weight of recombination
            end
