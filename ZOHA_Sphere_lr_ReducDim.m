classdef ZOHA_Sphere_lr_ReducDim < ZOHA_Sphere_lr
    properties
    ...
    methods
        function self = ZOHA_Sphere_lr_ReducDim(space_dimen, subspac_d, options)
            self@ZOHA_Sphere_lr(subspac_d, options);
