classdef Concat_Optimizer < handle
    ...
    properties
   	...
   	methods
   		function obj = ZOHA_Sphere_lr_euclid(space_dimen_list, optimizer1, optimizer2)
        ...
        function [new_samples, new_ids, TrialRecord] =  doScoring(obj, codes, scores, maximize, TrialRecord)
            ...
            [new_codes1, new_ids, TrialRecord] =  obj.optimizer1.doScoring(codes_part1, scores, maximize, TrialRecord);
            [new_codes2,       ~, TrialRecord] =  obj.optimizer2.doScoring(codes_part2, scores, maximize, TrialRecord);
