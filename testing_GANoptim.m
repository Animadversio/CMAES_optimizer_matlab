...
options = struct("population_size",40, "select_cutoff",20, "lr_sph",2, "mu_sph",0.005, "lr_norm", 10, "mu_norm", 10, "Lambda",1, ...
...
% 30 x 4096
init_genes = normrnd(0,1,30,4096);% have to make sure the first row cannot be all 0. 
